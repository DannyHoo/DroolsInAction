package com.danny.drools.dynamicrules.controller;
...
public class IndexController {
    ...
    @RequestMapping("/calc")
    @ResponseBody
    public Map<String, Object> getGoodsInfo(HttpServletRequest request, PointDomain pointDomain) throws IOException {
